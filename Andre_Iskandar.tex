...
\section{Projects}
    \resumeSubHeadingListStart
      \resumeProjectHeading
          {\textbf{\href{https://romantic-meninsky-7e0882.netlify.app/}
          ...
          \resumeItemListStart
            ...
            \resumeItem{\textbf{Automated-Testing}: Jest, Storybook, Cypress}
            \resumeItem{\textbf{Deployment}: CircleCI, Heroku, Netlify, 
            \href{https://github.com/andreiskandar/scheduler}{Github}}
          \resumeItemListEnd
      \resumeProjectHeading
          ...
          \resumeItemListStart
            \resumeItem{\textbf{Front-end}: jQuery, EJS $|$ \textbf{Back-end}: Express, Node, ElephantSQL}
            \resumeItem{\textbf{Unit-Testing}: Mocha, Chai}
          \resumeItemListEnd
      \resumeProjectHeading
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Identified potential safety hazards and take appropriate actions to control and/or eliminate hazards }
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Managed quality control objectives and priorities and consolidated information with management in analyzing quality opportunities to develop and implement an effective quality control program}
...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Full Stack Web Development Bootcamp}{Aug 2020 - Nov 2020}
    \resumeSubheading
