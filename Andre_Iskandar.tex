...
\section{Projects}
    \resumeSubHeadingListStart
     \resumeProjectHeading
          ...
          {\underline{ADTime Scheduling}}} $|$ \emph{A Full-stack Scheduler Web App with Slackbot and Twillio integration allowing users to assign weekly } \\
          \emph{shifts to employees, get reminders of upcoming events, request shift transfers, copy schedule to following weeks, and} \\
          \emph{change availability}}
      ...
      \resumeProjectHeading
          ...
          {\underline{Interview Scheduler}}} $|$ \emph{A Full-stack Single Page Web App allowing users to book, edit and cancel interview}}{}
          \resumeItemListStart
          ...
          \resumeItemListEnd
      \resumeProjectHeading
          {\textbf{\href{https://github.com/andreiskandar/quiz-app}{\underline{Quiz-App}}} $|$ \emph{A Full-stack Single Page Web App allowing users to create, take and share quizzes and to see results}}{}
          \resumeItemListStart
            \resumeItem{\textbf{Front-end}: jQuery, EJS $|$ \textbf{Back-end}: Express, Node, ElephantSQL    $|$ \textbf{Unit-Testing}: Mocha, Chai}
          \resumeItemListEnd
      \resumeProjectHeading
          {\textbf{\href{https://github.com/andreiskandar/tweeter}{\underline{Tweeter}}} $|$ \emph{A Simplified Single-Page App Twitter clone allowing users to compose and display tweets of 140 characters}}{}
          \resumeItemListStart
